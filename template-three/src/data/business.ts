...
export const business = {
  ...
  // PLACEHOLDER, wire per client. Canonical site origin with NO trailing
  // slash. Used to build absolute URLs in sitemap.xml, robots.txt, and the
  // LocalBusiness / Service JSON-LD schemas. Replace with the real domain.
  siteUrl: "https://www.businessname.example",

  // PLACEHOLDER, wire per client. Target the quote forms POST to. Wire to
  // Formspree / Netlify Forms / a CRM endpoint. Left as "#" so an
  // unconfigured form is obvious during a real build.
  formEndpoint: "#",
